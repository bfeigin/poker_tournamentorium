module PokerCalculator
  class CardHolder
    ...
    def CardHolder.face_value(face)
      face.upcase!
    ...
    def build_from_face_suit(face, suit)
      suit.downcase!
      @face  = CardHolder::face_value(face)
    ...
    # Returns a string containing the representation of CardHolder
    #
    # CardHolder.new("7c").to_s                   # => "7c"
    def to_s
      FACES[@face].chr + SUITS[@suit].chr
    end

    # If to_card is called on a `CardHolder` it should return itself
    def to_card
      self
    end
    ...
    # Compute a hash-code for this CardHolder. Two CardHolders with the same
    ...
    #
    #     CardHolder.new("Ac").natural_value    # => 1
    #     CardHolder.new("Kc").natural_value    # => 12
    #     CardHolder.new("Ad").natural_value    # => 13
    def natural_value
